...
Una volta compreso il problema, forzando l'uso di un access point con password conosciuta e preimpostata, Wireshark è in grado di decodificare il traffico 802.11 della rete in questione (figura \ref{fig:03}).
